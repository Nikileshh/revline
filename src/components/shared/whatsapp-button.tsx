...
const PHONE = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER; // digits with country code, e.g. 919876543210
const MESSAGE = "Hi RevLine! I found you through the website — I'd like to join a session.";
...
/**
 * Fixed corner button that opens a WhatsApp chat with a predefined message.
 * Hidden until NEXT_PUBLIC_WHATSAPP_NUMBER is set.
 */
